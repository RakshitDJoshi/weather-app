...
const forecast = (location, callback) => {
    ...
    request({ url, json: true }, (error, { body } = {}) => {
        if (error) {
            ...
            callback(undefined, body.current.condition.text + '. Current temperature is ' + body.current.temp_c + ' degree C. But, it feels like ' + body.current.feelslike_c + ' degree C.')
        }
    })
}
